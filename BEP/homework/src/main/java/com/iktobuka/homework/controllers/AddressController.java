...
import com.iktobuka.homework.services.AddressDao;
...
public class AddressController {
	...
	public AddressEntity createAddress(
		...
		return addressService.createAddressDao(
				street,
				city,
				country
			);
	...
	public AddressEntity deleteAddress(@PathVariable Integer id) {
		Optional<AddressEntity> addressOptional = addressRepository
												 .findById(id);
	...
	@GetMapping("/by-city")
	public List<AddressEntity> getAddressByCity(
			@RequestParam String city
		) {
	...
	public List<AddressEntity> getAddressByCountry(
			@RequestParam String country
		) {
	...
	public List<AddressEntity> findAddressForAUser(
